...
func (fake *FakeEdgeRepository) CreateOne(arg1 context.Context, arg2 model.CreateEdgeParams) (model.Edge, error) {
...
func (fake *FakeEdgeRepository) CreateOneCalls(stub func(context.Context, model.CreateEdgeParams) (model.Edge, error)) {
	fake.createOneMutex.Lock()
	defer fake.createOneMutex.Unlock()
	fake.CreateOneStub = stub
}

func (fake *FakeEdgeRepository) CreateOneArgsForCall(i int) (context.Context, model.CreateEdgeParams) {
	fake.createOneMutex.RLock()
	defer fake.createOneMutex.RUnlock()
...
func (fake *FakeEdgeRepository) CreateOneReturns(result1 model.Edge, result2 error) {
	fake.createOneMutex.Lock()
	defer fake.createOneMutex.Unlock()
...
func (fake *FakeEdgeRepository) CreateOneReturnsOnCall(i int, result1 model.Edge, result2 error) {
	fake.createOneMutex.Lock()
	defer fake.createOneMutex.Unlock()
	fake.CreateOneStub = nil
...
func (fake *FakeEdgeRepository) FindOne(arg1 context.Context, arg2 string) (model.Edge, error) {
...
func (fake *FakeEdgeRepository) FindOneCalls(stub func(context.Context, string) (model.Edge, error)) {
	fake.findOneMutex.Lock()
...
func (fake *FakeEdgeRepository) FindOneReturns(result1 model.Edge, result2 error) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
...
func (fake *FakeEdgeRepository) FindOneReturnsOnCall(i int, result1 model.Edge, result2 error) {
	fake.findOneMutex.Lock()
	defer fake.findOneMutex.Unlock()
	fake.FindOneStub = nil
...
func (fake *FakeEdgeRepository) GetList(arg1 context.Context, arg2 int64) ([]model.Edge, error) {
...
func (fake *FakeEdgeRepository) GetListCalls(stub func(context.Context, int64) ([]model.Edge, error)) {
	fake.getListMutex.Lock()
...
func (fake *FakeEdgeRepository) GetListReturns(result1 []model.Edge, result2 error) {
	fake.getListMutex.Lock()
	defer fake.getListMutex.Unlock()
...
func (fake *FakeEdgeRepository) GetListReturnsOnCall(i int, result1 []model.Edge, result2 error) {
	fake.getListMutex.Lock()
	defer fake.getListMutex.Unlock()
	fake.GetListStub = nil
...
func (fake *FakeEdgeRepository) UpdateOne(arg1 context.Context, arg2 model.UpdateEdgeParams) error {
...
func (fake *FakeEdgeRepository) UpdateOneCalls(stub func(context.Context, model.UpdateEdgeParams) error) {
	fake.updateOneMutex.Lock()
	defer fake.updateOneMutex.Unlock()
	fake.UpdateOneStub = stub
}

func (fake *FakeEdgeRepository) UpdateOneArgsForCall(i int) (context.Context, model.UpdateEdgeParams) {
	fake.updateOneMutex.RLock()
	defer fake.updateOneMutex.RUnlock()
